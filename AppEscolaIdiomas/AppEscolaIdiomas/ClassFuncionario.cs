...
namespace AppEscolaIdiomas
{
    class ClassFuncionario
    {
        ...
        public bool Inserir(string codUsuarioLogado)
        {
            try
            {
                ...
                bd.ExecutarComandosSql(String.Format("INSERT INTO Funcionario  VALUES ('{0}','{1}','{2}','{3}','{4}','{5}','{6}',{7},'{8}')",
                    CodFunc, Nome, Email, DataNas, Cpf, Telefone, Senha, CodTipo, codUsuarioLogado));
        ...
        //Editar Funcionario
        public bool Editar(string codFuncionario)
        {
            try
            {
                bd.Conectar();
        ...
        public void EnviarSenha(string emailRecuperar, string senha)
        {
            ...
            usuario.Send("idiomasescola67@gmail.com", emailRecuperar, "Senha recuperada Escola de Idiomas.", "Sua senha recuperada é: " + senha + ".");
        }
